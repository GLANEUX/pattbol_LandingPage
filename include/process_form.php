...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $name = filter_input(INPUT_POST, 'your-name', FILTER_SANITIZE_STRING);
		...
		<table class=\"table\" style=\"width:100%\">
			<tr>
				...
				<td style=\"padding:7px 0\">
					<font size=\"2\" face=\"Open-sans, sans-serif\" color=\"#555454\">
						<span style=\"color:#333\"><strong>Bonjour,<br/><br/>Une nouvelle demande d'information a été postée sur le site Internet Patt'Bol</strong></span><br /><br />
							<span style=\"color:#333\"><strong>Demande de : </strong></span>$name<br /><br />
							<span style=\"color:#333\"><strong>Adresse mail : </strong></span>$email<br /><br />
							<span style=\"color:#333\"><strong>Numéro de téléphone : </strong></span>$telephone<br /><br />
							...
							<span style=\"color:#333\"><strong>Cet e-mail a été envoyé via le formulaire de contact de Patt'Bol. Cordialement</strong></span><br /><br />						
					</font>
				</td>
				<td width=\"10\" style=\"padding:7px 0\">&nbsp;</td>
			</tr>
